...
namespace Lxc.VisionPlus.ImageView.Model
{
    ...
    public class ROIImage : ROI
    {
        ...
        public ROIImage(double row1, double col1, double row2, double col2)
        {
            createRectangle1(row1, col1, row2, col2);
        }
        public void UpdateROI(double row1, double col1, double row2, double col2)
        {
            this.row1 = row1;
            this.col1 = col1;
            this.row2 = row2;
            this.col2 = col2;
            Row = (this.row1 + this.row2) / 2.0;
            Column = (this.col1 + this.col2) / 2.0;
        ...
        public override void draw(HalconDotNet.HWindow window, int imageWidth, int imageHeight)
        {
            ...
            window.DispRectangle2(row1, col2, 0, littleRecSize + 5, littleRecSize + 5);
            window.DispRectangle2(row2, col2, 0, littleRecSize + 5, littleRecSize + 5);
            window.DispRectangle2(row2, col1, 0, littleRecSize + 5, littleRecSize + 5);
            window.DispRectangle2(Row, Column, 0, littleRecSize + 5, littleRecSize + 5);
            window.DispRectangle2((row1 + row2) / 2, col1, 0, littleRecSize + 5, littleRecSize + 5);
            window.DispRectangle2((row1 + row2) / 2, col2, 0, littleRecSize + 5, littleRecSize + 5);
            window.DispRectangle2(row1, (col1 + col2) / 2, 0, littleRecSize + 5, littleRecSize + 5);
            window.DispRectangle2(row2, (col1 + col2) / 2, 0, littleRecSize + 5, littleRecSize + 5);
        }
        ...
        public override double distToClosestHandle(double x, double y)
        {
            ...
            val[4] = HMisc.DistancePp(y, x, Row, Column); // midpoint 
