...
namespace VControls.VScrollBar
{
    ...
    [DefaultEvent("Scroll")]
    public class VVScrollbar : VControlBase
    {
        /// <summary>
        /// The mo large change
        /// </summary>
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            VControlHelper.PaintTriangle(e.Graphics, new SolidBrush(thumbColor), new Point(this.Width / 2, btnHeight - Math.Min(5, this.Width / 2)), Math.Min(5, this.Width / 2), VGraphDirection.Upward);
            VControlHelper.PaintTriangle(e.Graphics, new SolidBrush(thumbColor), new Point(this.Width / 2, this.Height - (btnHeight - Math.Min(5, this.Width / 2))), Math.Min(5, this.Width / 2), VGraphDirection.Downward);
