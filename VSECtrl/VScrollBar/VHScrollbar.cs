...
{
    [Designer(typeof(VScrollbarControlDesigner))]
    [DefaultEvent("Scroll")]
    public class VHScrollbar : VControlBase
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            VControlHelper.PaintTriangle(e.Graphics, new SolidBrush(thumbColor), new Point(btnWidth - Math.Min(5, this.Height / 2), this.Height / 2), Math.Min(5, this.Height / 2), VGraphDirection.Leftward);
            VControlHelper.PaintTriangle(e.Graphics, new SolidBrush(thumbColor), new Point(this.Width - (btnWidth - Math.Min(5, this.Height / 2)), this.Height / 2), Math.Min(5, this.Height / 2), VGraphDirection.Rightward);
