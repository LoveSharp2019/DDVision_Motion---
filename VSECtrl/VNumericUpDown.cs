...
namespace VControls
{
    ...
    public partial class VNumericUpDown : UserControl
    {
        public VNumericUpDown()
        {
            InitializeComponent();
            nud_value.BackColor = VUI.WinBackColor;
        ...
        public override Font Font
        {
            ...
            {
                base.Font = value;
                nud_value.Font = value;
                // btn_sub.Location=new Point(nud_value.Location.X+nud_value.Width, 0);
                //设定每个控件的大小
                // this.Invalidate();
            }
        }
        ...
        private void btn_sub_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    nud_value.Text= MinValue.ToString();
                }
                if (nud_value.Value <= MinValue)
                {
                    btn_sub.FlatAppearance.MouseDownBackColor = Color.White;
