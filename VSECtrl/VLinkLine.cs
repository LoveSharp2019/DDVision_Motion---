...
namespace VControls
{
    public partial class VLinkLine : UserControl
    {
        public VLinkLine()
        {
            InitializeComponent();
        }
       public string NoUseLine = "";
       public TreeNodeCollection Nodes;
       public event EventHandler CallBackNodes;
        public event EventHandler LineChange;
        public string LineText {
            get { return vTextBox1.TextStr; }
            set { vTextBox1.TextStr = value;}
        }
        public string LineCaptiion
        {
