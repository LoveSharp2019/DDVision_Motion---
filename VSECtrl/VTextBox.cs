...
namespace VControls
{
    ...
    public partial class VTextBox : UserControl
    {
        public VTextBox()
        {
            ...
            tbx_text.BackColor = VUI.WinBackColor;
        ...
        { 
            get { return tbx_text.ReadOnly; }
            set { tbx_text.ReadOnly = value;}
        }
        /// <summary>
        /// 文本改变事件
        /// </summary>
            ...
            set
            {
                ...
                else
                {
                    if (PasswordChar)
                        ...
                        tbx_text.PasswordChar = '\0';
                    tbx_text.ForeColor = Color.FromArgb(224, 224, 224);
                    _text = value;
                    tbx_text.Text = _text;
                }
            }
        ...
        {
            lbl_line.Height = 2;
            lbl_line.BackColor = Color.DeepSkyBlue;
