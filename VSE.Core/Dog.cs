...
namespace VSE.Core
{
    ...
    {
        [DllImport("LXC.CoreDog.dll", EntryPoint = "GetState", CallingConvention = CallingConvention.Cdecl)]
        private static extern bool GetState();
        [DllImport("LXC.CoreDog.dll", EntryPoint = "CheckActive", CallingConvention = CallingConvention.Cdecl)]
        public static extern int CheckActive();
        ...
        {
            public static Dictionary<string, ManagementObjectCollection> WmiDict = new Dictionary<string, ManagementObjectCollection>();
